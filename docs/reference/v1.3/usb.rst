...
.. note::
   The USB interface cannot be used for data transfer! 
   
   The Mini PCIe interface is used for data transfer between the host and LimeSDR XTRX.
...
.. table:: Table 9. USB 2.0 controller interface
